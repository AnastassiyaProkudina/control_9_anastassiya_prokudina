...
from gallery.views.photos import PhotoCreateView, PhotoUpdateView, PhotoDeleteView, PhotoDetail
...
urlpatterns = [
    ...
    path(
        "photo/<int:pk>/update/", PhotoUpdateView.as_view(), name="photo_update"
    ),
    path(
        "photo/<int:pk>/delete/", PhotoDeleteView.as_view(), name="photo_delete"
    ),
    path(
